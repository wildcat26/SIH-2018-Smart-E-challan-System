...
<form method="POST" action="/authenticate.php">
  ...
  <button type="submit" class="btn btn-default">Login</button>
      ...
      <div class="card text-white bg-secondary my-4 text-center">
        <div class="card-body">
          <p class="text-white m-0">This space is to add additional notices for E-challan system</p>
        </div>
      </div>
    ...
    <footer class="py-5 bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; NutshellNorthies.org</p>
      </div>
      <!-- /.container -->
    </footer>
