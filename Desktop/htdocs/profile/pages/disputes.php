...
<head>
    ...
    <title>Disputes - E Challan</title>
...
if((isset($_GET['searchtype']))){
    ...
    //$fdate=$_GET['fdate'];
    //$ldate=$_GET['ldate'];
	$disputes = searchDisputes($DBcon,$searchType);
...
<div class="col-lg-14">
<h1 class="page-header">Review Challan Disputes</h1>
<div class="col-md-10 ">
									...
									if($validSearch=="yes"){
                                        ...
                                        <div class="btn-group">
											...
											<button class="btn btn-primary active" type="submit">
											 <span class="glyphicon glyphicon-ok"></span> Resolve Selected Disputes.
											</button>
										...
										foreach($disputes as $dispute){
                                            ...
                                            <td>
                                                ...
                                                <a href="editviolation.php?id=<?php echo $id; ?>"><?php echo $id; ?></a>
                                                    <a class="text-warning" onclick="return confirm('Are you sure?');" href="disputes.php?action='remove'&deid=<?php echo $id; ?>"><b>Remove</b></a>
                                                </td>
