...
if(isset($_POST['uname'])){
	...
	$ao->setOfname($_POST['uname']);
	$ao->setOfemail($_POST['uemail']);
	$ao->setOfpass($_POST['pwd']);
    $ao->setOfmobile($_POST['contactnumber']);
	$ao->setCofpass($_POST['cpwd']);
	$ao->setOfficer_Rank($_POST['role']);
