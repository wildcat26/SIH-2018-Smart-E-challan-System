...
Indian Institute of Technology Palakkad | भारतीय प्रौद्योगिकी संस्थान पालक्काड</h4>-->
      ...
      <div class="row">
        <div class="col-sm-8">
          ...
          <form id="registerForm" method="post">
              <div class="mb-3">
                <label for="firstName">Name in Full (As in 10th Std / SSLC Certificate )</label>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-5">
            ...
            <hr class="mb-1">
			<small class="text-muted">Once Registeration completes, Please check inbox/spam for verfication link.</small>
